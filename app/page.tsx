    ...
    <div className="space-y-16">
      ...
      <section className="relative py-12 sm:py-20">
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <div
            className="absolute top-1/2 -translate-y-1/2 left-[5%] lg:left-[2%] h-[260px] w-[380px] rounded-full blur-[90px] opacity-[0.14] light:opacity-25"
            style={{
              background:
                "radial-gradient(circle, var(--app-hero-glow-inner) 0%, var(--app-hero-glow-outer) 42%, transparent 72%)",
            }}
          />
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
          ...
          <div className="relative flex-1 text-center lg:text-left">
            <div
              className="pointer-events-none absolute -inset-x-4 -inset-y-2 -z-10 rounded-2xl hidden lg:block"
              style={{
                background:
                  "linear-gradient(to right, var(--app-hero-scrim), var(--app-hero-scrim-mid), transparent)",
              }}
              aria-hidden
            />
            <div
              className="pointer-events-none absolute -inset-x-4 -inset-y-2 -z-10 rounded-2xl lg:hidden"
              style={{ backgroundColor: "var(--app-hero-scrim)" }}
              aria-hidden
            />
            <HeroReveal delay={0.05}>
              <p className="font-orbitron text-xs tracking-[0.2em] text-theme-accent opacity-75 mb-4 uppercase">
            ...
            <HeroReveal delay={0.25}>
              <p className="text-sm text-theme-accent opacity-80 mb-4">
                作者笔名：时寂
              </p>
            </HeroReveal>

            <HeroReveal delay={0.35}>
              <h2 className="text-xl sm:text-2xl text-theme-heading mb-2 font-light">
                当意识可以被数据化，死亡还算终点吗？
              </h2>
            </HeroReveal>

            <HeroReveal delay={0.45}>
              <p className="text-theme-muted max-w-2xl mb-8 text-sm sm:text-base leading-relaxed lg:mx-0 mx-auto">
      ...
      <section className="grid grid-cols-2 gap-4 sm:gap-6 max-w-md mx-auto">
        <NeonCard className="p-6 text-center" glow="cyan">
          <MessageSquare className="size-6 text-theme-accent mx-auto mb-2" />
          <p className="font-orbitron text-3xl font-bold text-theme-accent">
            {stats.threads}
          </p>
          <p className="text-sm text-theme-muted mt-1">讨论帖</p>
        </NeonCard>
        <NeonCard className="p-6 text-center" glow="purple">
          <Users className="size-6 text-theme-accent-secondary mx-auto mb-2" />
          <p className="font-orbitron text-3xl font-bold text-theme-accent-secondary">
            {stats.comments}
          </p>
          <p className="text-sm text-theme-muted mt-1">评论</p>
        </NeonCard>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-medium text-theme-accent">最新讨论</h2>
          <Link
            href="/discussions"
      ...
      <section className="text-center py-8 space-y-6">
        <NeonCard className="p-8 max-w-3xl mx-auto" glow="purple">
          <p className="font-orbitron text-xs tracking-[0.2em] text-theme-accent opacity-60 mb-3">
            ABOUT · 作品简介
          </p>
          <p className="text-theme-muted text-sm leading-relaxed text-left sm:text-center">
        ...
        <NeonCard className="p-6 max-w-3xl mx-auto" glow="cyan">
          <p className="font-orbitron text-xs tracking-[0.2em] text-theme-accent-secondary opacity-60 mb-3">
            FORUM · 讨论区说明
          </p>
