  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="absolute inset-0 rounded-[4px] bg-[var(--color-cyber-accent)]/8 blur-2xl"
          style={{ transform: "scale(0.94) translateY(6px)" }}
        />

        <div
          className="relative overflow-hidden rounded-[4px] border border-white/10 shadow-[0_24px_48px_rgba(0,0,0,0.5)]"
        ...
        >
          ...
          />
          <motion.div
            className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-[var(--color-cyber-accent)]/8 mix-blend-screen"
